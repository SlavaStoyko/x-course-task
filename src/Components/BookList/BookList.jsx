...
export const BookList = () =>{
   ...
   const handlerSearch = (value) =>{setSearchBook(value);} 
   const handlerOption = ({target:{value}}) => {setOption(value);}
   return (
      <>
        ...
        <article className="search_panel">
                       <form>
                        <label htmlFor="searchBooksPanel"></label>
                        <input onChange={(event)=>handlerSearch(event.target.value)} type="search" id="searchBooksPanel" value={searchBook}  name="searchBooksPanel" placeholder="Search by book name"></input>
                ...
                <article className="option_panel">
                    <label htmlFor="filter_list"></label>
                        <select onChange={(e)=>handlerOption(e)}id="filter_list" name="filter_list" >
